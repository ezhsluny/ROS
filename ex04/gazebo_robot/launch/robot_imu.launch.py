...
def generate_launch_description():
    ...
    # Мосты для всех сенсоров включая IMU
    bridge = Node(
    ...
    # Узлы для визуализации данных IMU
    ...
    rviz = Node(
        ...
        executable='rviz2',
        name='rviz2',
        arguments=['-d', os.path.join(pkg_project_bringup, 'rviz', 'imu.rviz')],
    ...
    return LaunchDescription([
        ...
        TimerAction(
            period=3.0,
            actions=[bridge, imu_tf_broadcaster]
        ),
